  ...
  <>
    {fields.map((position, index) => (
      <>
        ...
        >
          <img className="flowers" src={flower1} alt="" />
        </div>
        ...
        >
          <img className="flowers" src={grassLeaves1} alt="" />
        </div>
        ...
        >
          <img className="leaves" src={grassLeaves2} alt="" />
        </div>
        ...
        >
          <img className="leaves" src={grassLeaves1} alt="" />
        </div>
        ...
        >
          <img className="rock1" src={rock2} alt="" />
        </div>
      </>
    ))}
  </>
  ...
  return (
    <>
      ...
      <div style={{ gridColumn: "7/8", gridRow: "6/7" }}>
        <img className="fence-horizontal" src={woodHorizontal} alt="" />
      </div>
      <div style={{ gridColumn: "8/9", gridRow: "6/7" }}>
        <img className="fence-horizontal" src={woodHorizontal} alt="" />
      </div>
      <div style={{ gridColumn: "9/10", gridRow: "6/7" }}>
        <img className="fence-post" src={woodPost} alt="" />
      </div>
      ...
      <div style={{ gridColumn: "2/3", gridRow: "6/7" }}>
        <img className="fence-half" src={woodHalf} alt="" />
      </div>
      ...
      <div style={{ gridColumn: "15/16", gridRow: "3/4" }}>
        <img className="flowers" src={flower2} alt="" />
      </div>
      ...
      <div style={{ gridColumn: "3/4", gridRow: "2/3" }}>
        <img className="stump" src={flower1} alt="" />
      </div>
